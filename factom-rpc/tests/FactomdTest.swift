...
class FactomdTest: UIViewController {
    ...
    func executeAllMethods() {
        ...
        self.factomd.entryCreditBalance(address: "EC2dTBH2Nc9t9Y7RFD3FYMN5ottoPeHdk6xqUWEc6eHVoBPj6CmH") { (response, error) in
            if response != nil {
        ...
        self.factomd.factoidBalance(address: "FA2jK2HcLnRdS94dEcU27rF3meoJfpUcZPSinpb7AwQvPRY6RL1Q") { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
                    if let balance = result["balance"] {
                        print(balance)
        ...
        self.factomd.multipleEcBalances(addresses: ["EC293AbTn3VScgC2m86xTh2kFKAMNnkgoLdXgywpPa66Jacom5ya","EC3ExcVhmGRJmavCf1LCMu8YiHCyU2CWVh5DmXRz6jfPHMbzJSCz"]) { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
                    if let currentheight = result["currentheight"] {
                        print(currentheight)
                    }
                }
            }else{
        ...
        self.factomd.multipleFctBalances(addresses: ["FA3uMAv9htC5y5u3ayzxNQKZNDpgrJVf49kJSKdVNxcYoNBbSLXc","FA3umgJaXdHjpSQyBUPC2uMFuoW9nM5Ymm8Sa2f2VKGSqsyx79nf"]) { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
                    if let lastsavedheight = result["lastsavedheight"] {
                        print(lastsavedheight)
                    }
                }            }else{
                print(error!.localizedDescription)
            }
        ...
        /// Get block height
        self.factomd.ablockByHeight(height: 1) { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
        ...
        self.factomd.dBlockByHeight(height: 14460) { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
                    if let dblock = result["dblock"] as? JSONObject {
                        if let header = dblock["header"] as? JSONObject {
                            print(header["dbheight"]!)
                        }
                    }
                }            }else{
        ...
        //directory-block
        self.factomd.directoryBlock(keymr: "7ed5d5b240973676c4a8a71c08c0cedb9e0ea335eaef22995911bcdc0fe9b26b") { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
                    if let header = result["header"] as? JSONObject {
                        if let prevblockkeymr = header["prevblockkeymr"] {
                            print(prevblockkeymr)
                        }
                    }
                }            }else{
                print(error!.localizedDescription)
        ...
        self.factomd.directoryBlockHead { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
                    if let keymr = result["keymr"] {
                        print(keymr)
                    }
                }            }else{
                print(error!.localizedDescription)
        ...
        //get chain head
        self.factomd.chainHead(chainId: "5a77d1e9612d350b3734f6282259b7ff0a3f87d62cfef5f35e91a5604c0490a3") { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
                    if let balance = result["balance"] {
                        print(balance)
        ...
        // reveal entry
        self.factomd.revealEntry(entry: "007E18CCC911F057FB111C7570778F6FDC51E189F35A6E6DA683EC2A264443531F000E0005746573745A0005746573745A48656C6C6F20466163746F6D21") { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
                    if let chainid = result["chainid"] {
                        print(chainid)
        ...
        // get entry
        self.factomd.entry(hash: "b11bb4e1dacea726224c05bf863092ba02d301de55c08039f381e6e0ad1cef0d") { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
                    if let chainid = result["chainid"] {
                        print(chainid)
        ...
        // entry-ack
        self.factomd.entryAck(txid: "9228b4b080b3cf94cceea866b74c48319f2093f56bd5a63465288e9a71437ee8") { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
                    if let committxid = result["committxid"] {
                        print(committxid)
        ...
        //entry-block
        self.factomd.entryBlock(keymr: "041c3fed14469a3d0f1a022e3d5321583065e691edb9223605c86766ff881883") { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
                    if let header = result["header"] as? JSONObject {
                        print(header["prevkeymr"]!)
                    }
                }            }else{
                print(error!.localizedDescription)
            }
        ...
        //entry-credit-rate
        self.factomd.entryCreditRate { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
        ...
        //pending-entries
        self.factomd.pendingEntries { (response, error) in
            if response != nil {
                if let result = response!["result"] as? [JSONObject] {
                    if let entryhash = result[0]["entryhash"] {
                        print(entryhash)
                    }
                }            }else{
                print(error!.localizedDescription)
        ...
        // factoidAck
        self.factomd.factoidAck(txid: "f1d9919829fa71ce18caf1bd8659cce8a06c0026d3f3fffc61054ebb25ebeaa0") { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
                    if let txid = result["txid"] {
                        print(txid)
        ...
        //properties
        self.factomd.properties { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
                    if let factomdversion = result["factomdversion"] {
                        print(factomdversion)
                    }
                }            }else{
                print(error!.localizedDescription)
            }
        ...
        //raw-data
        self.factomd.rawData(hash: "ee380f524689af957528c91e5674d0226744d19630fa45daec794f1d0c0c0222") { (response, error) in
            if response != nil {
                if let result = response!["result"] as? JSONObject {
