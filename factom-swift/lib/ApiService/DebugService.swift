...
public class DebugService {
    ...
    public func holdingQueue(completion:@escaping (_ model:HoldingQueueModel?, _ error:GenError?) -> Void) {
    ...
    public func networkingInfo(completion:@escaping (_ model:NetworkInfoModel?, _ error:GenError?) -> Void) {
    ...
    public func predictiveFer(completion:@escaping (_ model:PredictiveFerModel?, _ error:GenError?) -> Void) {
    ...
    public func federatedServers(completion:@escaping (_ model:FederatedServersModel?, _ error:GenError?) -> Void) {
    ...
    public func configuration(completion:@escaping (_ model:ConfigurationModel?, _ error:GenError?) -> Void) {
    ...
    public func authorities(completion:@escaping (_ model:AuthoritiesModel?, _ error:GenError?) -> Void) {
    ...
    /// - Parameter completion: give response of type ConfigurationModel  if successful and error if request falis
    public func reloadConfiguration(completion:@escaping (_ model:ConfigurationModel?, _ error:GenError?) -> Void) {
    ...
    public func dropRate(completion:@escaping (_ model:DropRateModel?, _ error:GenError?) -> Void) {
    ...
    /// - Parameter completion: give response of type DropRateModel  if successful and error if request falis
    public func setDropRate(completion:@escaping (_ model:DropRateModel?, _ error:GenError?) -> Void) {
    ...
    public func delay(completion:@escaping (_ model:DelayModel?, _ error:GenError?) -> Void) {
    ...
    /// - Parameter completion: give response of type DelayModel  if successful and error if request falis
    public func setDelay(completion:@escaping (_ model:DelayModel?, _ error:GenError?) -> Void) {
    ...
    public func summary(completion:@escaping (_ model:SummaryModel?, _ error:GenError?) -> Void) {
    ...
    public func messages(completion:@escaping (_ model:MessagesModel?, _ error:GenError?) -> Void) {
