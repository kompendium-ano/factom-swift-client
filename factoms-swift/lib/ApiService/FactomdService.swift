...
public class FactomdService {
    ...
    public func ablockByHeight(height:Int ,completion:@escaping ((_ model:ABlockByHeightModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func chainHead(chainId:String ,completion:@escaping (_ model:ChainHeadModel?, _ error:ErrorModel?) -> Void){
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func commitChain(message:String ,completion:@escaping (_ model:CommitChainModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter message: pass a message of type string
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func commitEntry(message:String ,completion:@escaping (_ model:CommitEntryModel?, _ error:ErrorModel?) -> Void) {
        //convert string to hex
        let data = Data(message.utf8)
        let hexString = data.map{ String(format:"%02x", $0) }.joined()
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func currentTime(completion:@escaping (_ model:CurrentMinuteModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func dBlockByHeight(height:Int64 ,completion:@escaping (_ model:DBlockByHeightModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter keymr: pass a keymr of type String
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func directoryBlock(keymr:String ,completion:@escaping (_ model:DirectoryBlockModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func directoryBlockHead(completion:@escaping (_ model:DirectoryBlockHeadModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter hash: pass a string
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func entry(hash:String ,completion:@escaping (_ model:EntryModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func entryAck(txid:String ,completion:@escaping (_ model:EntryAckModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter keymr: pass a keymr of type String
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func entryBlock(keymr:String ,completion:@escaping (_ model:EntryBlockModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func entryCreditBalance(address:String ,completion:@escaping (_ model:EntryCreditBalanceModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func entryCreditRate(completion:@escaping (_ model:EntryCreditRateModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter txid: transactionId of type string
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func factoidAck(txid:String ,completion:@escaping (_ model:FactoidAckModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter address: pass an address of type string
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func factoidBalance(address:String ,completion:@escaping (_ model:FactoidBalanceModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func factoidSubmit(transaction:String ,completion:@escaping (_ model:FactoidSubmitModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func heights(completion:@escaping (_ model:HeightsModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func multipleEcBalances(addresses:[String] ,completion:@escaping (_ model:MultipleBalancesModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter addresses: pass an address of type string
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func multipleFctBalances(addresses:[String] ,completion:@escaping (_ model:MultipleBalancesModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func pendingEntries(completion:@escaping (_ model:PendingEntriesModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func rawData(hash:String ,completion:@escaping (_ model:RawDataModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func revialChain(entry:String ,completion:@escaping (_ model:RevealModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter entry: pass an entry of type string
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func revealEntry(entry:String ,completion:@escaping (_ model:RevealModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter message: pass a message of type string
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func sendRawMessageToCheckCommit(message:String ,completion:@escaping (_ model:RawMessageModel?, _ error:ErrorModel?) -> Void) {
    ...
    /// - Parameter message: pass a message of type string
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func sendRawMessageToCheckRevealChain(message:String ,completion:@escaping (_ model:RawMessageModel?, _ error:ErrorModel?) -> Void) {
