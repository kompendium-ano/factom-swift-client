...
public class FactomWalletdService {
    ...
    public func activeIdentityKeys(chainId:String, height:Double, completion:@escaping ((_ model:ActiveIdentityKeysModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func addEcOutput(txName:String, address:String, amount:Double ,completion:@escaping ((_ model:AddECOutputModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter amount: amount of type double
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func addFee(txName:String, address:String, amount:Double ,completion:@escaping ((_ model:AddFeeModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter amount: amount of type double
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func addInput(txName:String, address:String, amount:Double ,completion:@escaping ((_ model:AddInputModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter amount: amount of type double
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func addOutput(txName:String, address:String, amount:Double ,completion:@escaping ((_ model:AddOutputModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter address: address of type String
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func address(address:String ,completion:@escaping ((_ model:AddressModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func allAddress(completion:@escaping ((_ model:AllAddressesModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
       public func allIdentityKeys(completion:@escaping ((_ model:AllIdentityKeysModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func composeChain(extids:[String], content:String, ecpub:String ,completion:@escaping ((_ model:ComposeModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter ecpub: pass a string
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func composeEntry(chainId:String, extids:[String], content:String, ecpub:String ,completion:@escaping ((_ model:ComposeModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func composeIdentityAttribute(receiverChainId:String, destinationChainId:String, attributes:[String:Any], signerKey:String, signerChainId:String, ecpub:String, force:Bool, completion:@escaping ((_ model:ComposeModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter force: pass a boolean
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func composeIdentityAttributeEndorsement(destinationChainId:String, entryHash:String, signerKey:String, signerChainId:String, ecpub:String, force:Bool, completion:@escaping ((_ model:ComposeModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func composeIdentityChain(names:[String], pubkeys:[String] ,completion:@escaping ((_ model:ComposeModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter force: pass a boolean
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func composeIdentityKeyReplacement(chainId:String, oldkey:String, newkey:String, signerkey:String, ecpub:String, force:Bool, completion:@escaping ((_ model:ComposeModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter txName: transaction name of type string
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func composeTransaction(txName:String ,completion:@escaping ((_ model:ComposeTransactionModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter txName: transaction name of type string
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func deleteTransaction(txName:String ,completion:@escaping ((_ model:DeleteTransactionModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func generateEcAddress(completion:@escaping ((_ model:AddressModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// ‌Create a new Entry Credit Address and store it in the wallet.‌
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func generateFactoidAddress(completion:@escaping ((_ model:AddressModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func generateIdentityKey(completion:@escaping ((_ model:AddressModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func getHeight(completion:@escaping ((_ model:GetHeightModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func identityKey(publicKey:String ,completion:@escaping ((_ model:AddressModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func importAddress(addresses:[[String:String]], completion:@escaping ((_ model:AllAddressesModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter addresses: pass a array of dictionary
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func importIdentityKeys(keys:[[String:String]], completion:@escaping ((_ model:AllIdentityKeysModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func importKoinify(words:String, completion:@escaping ((_ model:AddressModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func newTransaction(txName:String, completion:@escaping ((_ model:NewTransactionModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func properties(completion:@escaping ((_ model:PropertiesModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func removeAddress(address:String, completion:@escaping ((_ model:RemoveAddressModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func removeIdentityKey(publicKey:String, completion:@escaping ((_ model:RemoveIdentityKeyModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func signData(signer:String, data:String,completion:@escaping ((_ model:SignDataModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter txName: pass a transaction name of type string
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func signTransaction(txName:String, completion:@escaping ((_ model:SignTransactionModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func subFee(txName:String, address:String, completion:@escaping ((_ model:SubFeeModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func tempTransactions(completion:@escaping ((_ model:TmpTransactionsModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func transactionUsingRange(start:Int, end:Int, completion:@escaping ((_ model:TransactionsModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func transactionById(txId:String, completion:@escaping ((_ model:TransactionsModelById?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func transactionByAddress(address:String, completion:@escaping ((_ model:TransactionsModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func unlockWallet(passPhrase:String, timeout:Int, completion:@escaping ((_ model:UnlockWalletModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func walletBackup(completion:@escaping ((_ model:WalletBackupModel?, _ error:ErrorModel?) -> Void)) {
    ...
    /// - Parameter completion: give response of type jsonObject  if successful and error if request falis
    public func walletBalances(completion:@escaping ((_ model:WalletBalancesModel?, _ error:ErrorModel?) -> Void)) {
